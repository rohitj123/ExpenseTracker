...
export const navbarStyles = {
  ...
  header: "sticky top-0 z-50 border-b border-white/60 bg-white/90 shadow-sm backdrop-blur-xl",
  container: "flex items-center justify-between px-4 py-3 md:px-8",
  
  // Logo styles
  logoContainer: "flex items-center gap-2 cursor-pointer",
  logoImage: "w-12 h-12 md:w-14 md:h-14 rounded-2xl overflow-hidden shadow-sm",
  
  // Text styles
  logoText: "text-xl md:text-3xl text-gray-900 font-[650] lobster-regular",
  
  // User profile styles
  userContainer: "relative",
  userButton: "flex items-center gap-2 rounded-2xl border border-gray-100 bg-white/80 px-3 py-2 shadow-sm hover:bg-indigo-50 hover:border-indigo-100",
  ...
  dropdownMenu: "absolute top-14 right-0 w-56 bg-white rounded-2xl shadow-xl border border-gray-100 z-50 overflow-hidden",
...
export const sidebarStyles = {
  // Layout and container styles
  sidebarContainer: {
    base: "flex lg:flex flex-col pt-3 fixed top-16 bottom-0 z-30"
  },
  
  sidebarInner: {
    base: "bg-white/95 backdrop-blur-xl border-r border-white/70 shadow-lg h-full flex flex-col overflow-hidden"
  },
  ...
  menuItem: {
    ...
    active: "text-indigo-700 bg-indigo-50 shadow-sm",
    inactive: "text-gray-600 hover:text-indigo-700 hover:bg-indigo-50/70",
  ...
  // Toggle button
  toggleButton: {
    base: "absolute -right-3 top-12 z-20 w-7 h-7 bg-white border border-gray-200 rounded-full flex items-center justify-center text-gray-500 hover:text-indigo-600 hover:border-indigo-300 hover:bg-indigo-50 shadow-sm transition-all"
  },
...
export const styles = {
  // Layout and Container Styles
  layout: {
    root: "min-h-screen bg-transparent text-gray-900",
    mainContainer: (sidebarCollapsed) => 
      `min-h-[calc(100vh-80px)] overflow-x-hidden px-4 py-5 sm:px-5 md:px-6 lg:px-8 transition-all duration-300 ${sidebarCollapsed ? 'lg:ml-20' : 'lg:ml-64'}`,
  },
